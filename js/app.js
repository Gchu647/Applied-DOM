(function(window) {
  ...
  function setMyLightGreen() {
    ...
    let greenColor = document.getElementById(lightId);greenColor.className = "light-green";
  }
  ...
  function setMyLightClass(event, desiredClass) {
    let lightId = this.dataset.lightId;
    let  newClass = document.getElementById(lightId);
    newClass.className = desiredClass;
  }
  ...
  btn1.addEventListener("click", function() {
    setMyLightGreen.apply(this); // Would invoke window withot this
  });
  ...
  btn2.addEventListener("click", () => {
    setMyLightGreen.apply(btn2); // doesn't let me change this
  });
...
// the function of evenListent automatically takes in mouse event.
